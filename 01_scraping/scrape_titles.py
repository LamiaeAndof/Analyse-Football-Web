...
input_path = "data/raw/titles_2025_global.xlsx"
output_path = "data/raw/titles_2025.csv"


# Vérification de l'existence du fichier
if not os.path.exists(input_path):
    print("❌ Le fichier titles_2025_global.xlsx n'a pas été trouvé dans data/raw/")
else:
